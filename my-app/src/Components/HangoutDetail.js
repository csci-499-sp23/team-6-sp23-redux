...
function HangoutDetail() {
    return(
        <div className={HangoutDetailCSS.Container}>
            <div id={HangoutDetailCSS.Title}>Brooklyn Bridge</div>
            <div id={HangoutDetailCSS.Location}>Williamsburg, NYC</div>
            <div id={HangoutDetailCSS.DescriptionContainer}>
                <img id={HangoutDetailCSS.Image} src="Images/SwipeableContainerImage.jpeg" alt="hangout-suggestion"></img>
