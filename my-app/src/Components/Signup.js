      ...
      <section class={LoginCSS.LoginContainer}>
        <div class={LoginCSS.LoginDiv}>
          <div>
            <form>
              <div>
                <label htmlFor="email-address" class={LoginCSS.LoginText}>
                  Email address
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="password" class={LoginCSS.LoginText}>
                  Password
                </label>
                <input
                  type="password"
              ...
              <button class={LoginCSS.LoginButton} type="submit" onClick={onSubmit}>
                Sign up
              </button>
            </form>
